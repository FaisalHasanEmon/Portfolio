          ...
          <div className="hero-content  flex-col lg:flex-row gap-9">
            ...
            <div>
              ...
              <p className="py-6">
                ...
                seamless user experiences with JavaScript and Tailwind CSS. I
                have worked on various projects, including e-commerce platforms,
                real estate websites, and pet adoption platforms, showcasing my
                ability to develop feature-rich applications. I also freelance
                on Fiverr, helping clients bring their ideas to life.
              </p>
            </div>
          </div>
        </div>
