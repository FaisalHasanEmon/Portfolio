...
const Education = () => {
  return (
    <Element name="education">
      <div className="h-[calc(100vh-65px)]  w-full p-10 ">
        ...
        <ul className=" flex justify-center items-center timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
          <li>
            ...
            <div className="timeline-start mb-10 md:text-end bg-white/10 backdrop-blur-3xl p-2 rounded-[6px]">
          ...
          <li>
            ...
            <div className="timeline-end md:mb-10  bg-white/10 backdrop-blur-3xl p-2 rounded-[6px]">
